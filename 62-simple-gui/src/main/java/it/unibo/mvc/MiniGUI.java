...
public class MiniGUI {
    ...
    public MiniGUI() {
        ...
        final JPanel exJPanel = new JPanel();
        exJPanel.setLayout(new BoxLayout(exJPanel,BoxLayout.X_AXIS));
        canvas.add(exJPanel, BorderLayout.CENTER);
        ...
        write.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent e) {
                ...
                result.setText("The Number is: " + output);
            }
        });
    }
